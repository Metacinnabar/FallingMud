...
namespace FallingMud
{
	public class FallingMud : Mod
	{
	}

	public class FMGlobalTile : GlobalTile
	{
		...
		public override bool TileFrame(int i, int j, int type, ref bool resetFrame, ref bool noBreak)
		{
			if (type == TileID.Mud)
			{
				return TileFrame_Sand(i, j, ModContent.ProjectileType<FallingMudProjectile>());
			}
